...
def run(metadata_fpath, detections_dir, out_fpath, min_confidence, nms_max_overlap, 
...
def parse_args():
    ...
    parser.add_argument(
        "--metadata_fpath", help="Path to MOTChallenge sequence directory",
        default=None, required=True)
    parser.add_argument(
        "--detections_dir", help="Path to custom detections.", default=None,
        required=True)
    parser.add_argument(
        "--out_fpath", help="Path to the tracking output file. This file will"
...
if __name__ == "__main__":
    args = parse_args()
    run(
        args.metadata_fpath, args.detections_dir, args.out_fpath,
